...
class TestBloomFilterSerializeDeserialize(unittest.TestCase):
    ...
    def test_raises_error_on_invalid_input(self):
        ...
        with self.assertRaises(zlib.error):
            BloomFilter.deserialize(base64.b64encode(b"abc"))

        with self.assertRaises(ValueError):
            BloomFilter.deserialize(base64.b64encode(zlib.compress(b"abc")))
...
class TestRotatingBloomFilter(unittest.TestCase):
    ...
    def test_rotate(self):
        ...
        list(bloom_filter.dedup(range(100)))
    ...
    def test_forgetfulness(self):
        ...
        bloom_filter = RotatingBloomFilter(10, 0.00001, 5)
        list(bloom_filter.dedup(range(100)))
        included = [i for i in range(100) if bloom_filter.test_by_hash(i)]
        self.assertEqual(included, list(range(60, 100)))
